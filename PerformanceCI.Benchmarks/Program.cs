...
/// <summary>Runs the portable suite and returns the PerfCI gate exit code.</summary>
public static class Program
{
    ...
    public static int Main(string[] args)
    {
        ...
        return PerfConsoleGate.RunAndReport(typeof(PortableBenchmarks), meanNs, meanBytes,
